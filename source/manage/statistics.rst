...
.. image:: ../images/restrict-role-access.png
   :alt: Restrict other users with Viewer role by giving No Access privileges
...
.. image:: ../images/assign-people-to-system-role.png
   :alt: Select Add People under Assigned People to assign Team Admins to Viewer role
